...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void btnProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProfileActionPerformed
        ...
        // Set the necessary data to ppMhs
        ppMhs.setNama_lengkap("Your Name" + ppMhs.getNama_lengkap());
        ppMhs.setNim("Your NIM");
        ppMhs.setNomor_hp("Your Phone Number");
        ppMhs.setAlamat_lengkap("Your Address");
//        System.out.println("" + ppMhs.getNama_lengkap() + "" + ppMhs.getNim() + "" + ppMhs.getNomor_hp() + "" +ppMhs.getAlamat_lengkap());
